...
const AboutUs = () => {
  return (
    <section id='about' className='px-7 md:px-14 flex flex-col md:flex-row justify-between gap-4 w-full h-full md:h-screen'>
      ...
      <div className='w-full h-1/2 md:w-1/2 md:h-full flex flex-col gap-4 justify-center'>
